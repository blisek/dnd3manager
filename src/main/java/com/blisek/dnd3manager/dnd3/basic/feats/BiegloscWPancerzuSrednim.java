...
public class BiegloscWPancerzuSrednim extends AbstractFeat implements
		ChainedRestrictedSystemObject {
	public static final String SYSTEM_NAME = "bwpsrednim";
	// TODO: może być niebezpieczne.
	protected final Collection<SystemObject> required = Arrays.asList(new BiegloscWPancerzuLekkim());
